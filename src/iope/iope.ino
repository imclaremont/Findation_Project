...
void loop() {
  while(digitalRead(g_button_pin) == LOW) {      
    ...
    if((g_redColor > 245 && g_redColor <= 255) && (g_greenColor > 235 && g_greenColor <= 245) && (g_blueColor > 225 && g_blueColor <= 235)) {
      lcd.println(" - IOPE C13 - ");
    }
    else if((g_redColor > 230 && g_redColor <= 245) && (g_greenColor > 220 && g_greenColor <= 235) && (g_blueColor > 210 && g_blueColor <= 225)) {
      lcd.println(" - IOPE C21 - ");
    } 
