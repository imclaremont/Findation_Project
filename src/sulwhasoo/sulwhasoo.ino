...
void loop() {
  while(digitalRead(g_button_pin) == LOW) {      
    ...
    if((g_redColor > 240 && g_redColor <= 255) && (g_greenColor > 230 && g_greenColor <= 245) && (g_blueColor > 220 && g_blueColor <= 235)) {
      lcd.println(" - Sulwhasoo 13호 - ");
    }
    else if((g_redColor > 230 && g_redColor <= 240) && (g_greenColor > 220 && g_greenColor <= 230) && (g_blueColor > 210 && g_blueColor <= 220)) {
      lcd.println(" - Sulwhasoo 21호 - ");
    } 
    else if((g_redColor > 220 && g_redColor <= 230) && (g_greenColor > 210 && g_greenColor <= 220) && (g_blueColor > 200 && g_blueColor <= 210)) {
      lcd.println(" - Sulwhasoo 23호 - ");
    } 
    else {
      lcd.println(" - Sulwhasoo Unknown - ");
    }
    delay(3000);
